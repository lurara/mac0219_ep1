#include <stdio.h>
#include <stdlib.h>
#include <omp.h>    // inclusão da lib. OpenMP
#include <math.h>
...
void compute_mandelbrot(){
    ...
    // abaixo, região paralela que possui a variável privada tal
    int nthreads, chunk;

    // define número de threads do programa
    #pragma omp parallel
        {
    ...
    chunk = (i_y_max)/nthreads;
    // printf("Chunk size = %d\n", chunk);

    #pragma omp parallel for    \
        default(shared) \
        private(i_y, c_y, c_x, z_x, z_y, z_x_squared, z_y_squared, iteration, i_x)  \
